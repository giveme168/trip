...
class Orders(models.Model):
    ...
    PAY_TYPE = ((0,u'银联'),(1,u'支付宝'),(2,u'财付通'))
    ...
    pay_type = models.IntegerField(u'付款方式', max_length=2, help_text=u'付款方式', default=1)
    pay_id = models.CharField(u'订单号', max_length=254, help_text="订单号")
